...
// We define an object that contains the layers. This overlay will be visible all the time. 
let overlays = {
    Earthquakes: earthquakes
};

// Add a control tot he map allowing the user to change visible layers. 
...
L.geoJSON(data, {
    ...
    pointToLayer: function(feature, latlng) {
            ...
            // Set the style for each circleMarker using out styleInfo function.
            style: styleInfo,
